...
@fixture
def result_of_the_colored_phrase():
    return (
...
def test_decorar_relatorio(mocked_product_list, result_of_the_colored_phrase):
    result = ColoredReport(SimpleReport)

    assert result.generate(mocked_product_list) == result_of_the_colored_phrase
